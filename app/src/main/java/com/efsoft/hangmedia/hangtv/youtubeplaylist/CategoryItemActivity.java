...
public class CategoryItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JsonUtils.setStatusBarGradiant(CategoryItemActivity.this);
        ...
        recyclerView.setLayoutManager(new GridLayoutManager(CategoryItemActivity.this, 2));
        ...
        jsObj.addProperty("method_name", "get_playlist");
    ...
    private void displayData() {
        adapter = new CatListAdapter(CategoryItemActivity.this, mListItem, true);
