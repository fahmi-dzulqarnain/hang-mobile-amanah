 ...
 * Created by laxmi.
 */
public class HomePlayListAdapter extends RecyclerView.Adapter<HomePlayListAdapter.ItemRowHolder> {
    ...
    public HomePlayListAdapter(Context context, ArrayList<ItemPlayList> dataList, boolean flag) {
    ...
    public ItemRowHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_home_playlist_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull final ItemRowHolder holder, final int position) {
        ...
        Picasso.get().load(singleItem.getImage()).placeholder(R.drawable.logo_hang_mobile_black_landscape).into(holder.image);
        holder.text_cat.setText(singleItem.getPlayCatName());
